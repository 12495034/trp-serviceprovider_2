        ...
        <div className='page-body'>
            <div className='page-content'>
                <div>
                    ...
                    <h6>Last updated: February 21, 2023</h6>
                    <p>This privacy policy governs your use of the software application “TRP - Rapid HIV Testing” (later referred as the/this “App”) for Android™ mobile devices that was created by Gavin Davis.
                        ...
                        at clinics scheduled by the rainbow project based on Belfast, Northern Ireland.
                    </p>
                </div>
                <div>
                    <div>
                    ...
                    <div>
                        ...
                        <ol>
                            <li>Users have the ability to check in for their clinic appointments using the app. The users check in status is automatically recorded in the Firestore database.
                                Users appointment histories are also recorded remotely in a secure Google firestore database. User appointment history is accessible only to the owner of that data and Rainbow project clinic administrators.
                            </li>
